  ...
  (function () {
    ...
    (c.INTERRUPT_ANY = "any"),
      ...
      (c.registerSound = function (a, b, d, e) {
        ...
        if (!g) return !1;
        if (
          (c._preloadHash[f.src] || (c._preloadHash[f.src] = []),
        ...
        return (
          null != f && null != f.src
            ? (b.create(f.src),
              ...
              (g = c.activePlugin.create(f.src, d, e || a.duration)))
            : (g = new createjs.DefaultSoundInstance(a, d, e)),
    ...
    (d.constructor = b),
      ...
      (d._getSlot = function (b) {
        ...
        for (var e = 0, f = this.max; f > e; e++) {
          ...
          b != a.INTERRUPT_NONE &&
            ((b == a.INTERRUPT_EARLY && c.getPosition() < d.getPosition()) ||
              (b == a.INTERRUPT_LATE && c.getPosition() > d.getPosition())) &&
            (d = c);
        }
  ...
  (function () {
    ...
    (b.play = function (a, b, c, d, e, f) {
      return this.playState == createjs.Sound.PLAY_SUCCEEDED
        ? (a instanceof Object &&
            ((c = a.offset), (d = a.loop), (e = a.volume), (f = a.pan)),
      ...
      (b.setLoop = function (a) {
        null != this._playbackResource &&
          (0 != this._loop && 0 == a && this._removeLooping(a),
  ...
  (function () {
    ...
    (c.MAX_INSTANCES = 30),
      ...
      (b.register = function (a, b) {
        for (
          var c = createjs.HTMLAudioTagPool.get(a.src), d = null, e = 0;
          b > e;
          e++
        )
